...
import { Loader2, RotateCw, User, Bot } from "lucide-react";
...
export default function GameInfoPanel({ status, turn, isAITurn, moveHistory, aiReasoning, onReset, gameMode, onGameModeChange }: GameInfoPanelProps) {
      ...
      <CardContent>
        <div className="flex flex-col gap-4 mb-4">
          <div className="flex items-center justify-between">
            ...
            <ToggleGroup type="single" value={gameMode} onValueChange={(value) => onGameModeChange(value as GameMode)} aria-label="Game Mode">
              <ToggleGroupItem value="pvp" aria-label="Player vs Player">
                <User className="h-4 w-4 mr-2"/>
                P vs P
              </ToggleGroupItem>
              <ToggleGroupItem value="pva" aria-label="Player vs AI">
        ...
        <Tabs defaultValue="history" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="ai" disabled={gameMode === 'pvp'}>AI Thoughts</TabsTrigger>
          </TabsList>
